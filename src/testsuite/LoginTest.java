...
public void userShouldNavigateToLoginPageSuccessfully(){
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials(){
        ...
        userName.sendKeys("sarojbenmalviya007@gmail.com");
        //find and fill the password filed
        WebElement passWord = driver.findElement(By.id("Password"));
        passWord.sendKeys("Harsh123@007");
    ...
    public void verifyTheErrorMessage(){
        ...
        emailField.sendKeys("Sarojmalviya@gmail.com");
        //Find the password field and type the password into password field
        driver.findElement(By.name("Password")).sendKeys("Hsh123@007");
